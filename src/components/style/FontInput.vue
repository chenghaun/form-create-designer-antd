            ...
            <div class="_fd-font-input">
                <a-form layout="vertical" size="small" >
                    ...
                    <a-form-item :label="t('style.weight.name')">
                        <a-select v-model="fontStyle.fontWeight" allowClear @change="onInput">
                            <a-select-option
                    ...
                    <a-form-item :label="t('style.decoration.name')">
                        <a-select v-model="fontStyle.textDecoration" allowClear @change="onInput">
                            <a-select-option
                    ...
                    <a-form-item :label="t('style.font.align')">
                        <a-select v-model="fontStyle.textAlign" allowClear @change="onInput">
                            <a-select-option
