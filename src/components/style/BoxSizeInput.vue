<template>
  <div class="_fd-box-size-input">
    ...
    >
      <template #append>
        <a-form label-position="top" size="small" layout="vertical">
          <a-form-item
            :label="t('style.' + key)"
            v-for="key in keys"
            :key="key"
          ...
          <a-form-item
            :label="t('style.overflow.name')"
            style="grid-column: span 2;"
          >
            <a-radio-group
              v-model:value="boxStyle.overflow"
              :modelValue="boxStyle.overflow"
            >
              <a-tooltip
                effect="dark"
                :title="t('style.overflow.' + item.value)"
                placement="top"
                persistent
                :hide-after="0"
...
._fd-box-size-input .ant-form-item:last-child {
  grid-column: span 2;
}
...
._fd-box-size-input .ant-radio-group {
  display: flex;
  width: 100%;
}

._fd-box-size-input .ant-radio-button-wrapper {
  flex: 1 !important;
  display: flex;
  align-items: center;
