<template>
    <div class="_fd-shadow-content">
        <a-form label-width="50px" layout="vertical" class="_fd-sc-form" size="small">
            <a-form-item :label="t('style.shadow.mode')">
                <a-radio-group v-model="form.type" @change="onInput" size="small" class="_fd-sc-radio">
                    <template v-for="item in options" :key="item.key">
                        <a-tooltip
                            ...
                            persistent
                        >
                            <a-radio-button :label="item.key" :value="item.key">
            ...
            <a-form-item :label="t('style.color')">
                <ColorInput v-model="form.color" @change="onInput"></ColorInput>
            </a-form-item>
            <a-form-item :label="t('style.shadow.x')">
                <a-input v-model:value="form.x" type="number" @change="onInput">
                    <template #append>
                        <a-select v-model="form.x_unit" @change="onInput">
                            <a-select-option v-for="item in units" :key="item" :label="item" :value="item"/>
                        </a-select>
                    </template>
                </a-input>
            </a-form-item>
            <a-form-item :label="t('style.shadow.y')">
                <a-input v-model:value="form.y" type="number" @change="onInput">
                    <template #append>
                        <a-select v-model="form.y_unit" @change="onInput">
                            <a-select-option v-for="item in units" :key="item" :label="item" :value="item"/>
                        </a-select>
                    </template>
                </a-input>
            </a-form-item>
            <a-form-item :label="t('style.shadow.vague')">
                <a-input v-model:value="form.vague" type="number" @change="onInput">
                    <template #append>
                        <a-select v-model="form.vague_unit" @change="onInput">
                            <a-select-option v-for="item in units" :key="item" :label="item" :value="item"/>
                        </a-select>
                    </template>
                </a-input>
            </a-form-item>
            <a-form-item :label="t('style.shadow.extend')">
                <a-input v-model:value="form.extend" type="number" @change="onInput">
                    <template #append>
                        <a-select v-model="form.extend_unit" @change="onInput">
                            <a-select-option v-for="item in units" :key="item" :label="item" :value="item"/>
                        </a-select>
                    </template>
                </a-input>
...
._fd-shadow-content .ant-form-item {
    display: grid
}
...
._fd-shadow-content .ant-select {
    width: 64px;
    padding: 0
}

._fd-shadow-content ._fd-color-input {
    width: 100%
}
...
._fd-shadow-content ._fd-sc-radio .ant-radio-button-wrapper {
    display: flex;
    flex: 1;
    align-items: center;
