  ...
  >
    <a-layout-content>
      <a-layout style="height: 100%;" :key="locale && locale.name">
        <a-layout-sider class="_fc-l-menu" width="40px" theme="light">
          <a-tooltip
            effect="dark"
        ...
        >
          ...
          <a-layout style="height: 100%;" v-if="activeModule === 'base'">
            <a-layout-header height="40px" class="_fc-l-tabs" theme="light">
              <div
                class="_fc-l-tab"
            ...
            <a-layout-content v-show="activeMenuTab === 'menu'" theme="light">
            ...
            <a-layout-content v-if="activeMenuTab === 'tree'" theme="light">
              <a-tree
                ref="treeRef"
                :tree-data="treeInfo"
                default-expand-all
        ...
        <a-layout class="_fc-m" theme="light">
          <a-layout-header class="_fc-m-tools" height="45">
            ...
            <div class="_fc-m-tools-r">
              <template v-if="!inputForm.state">
                ...
                <a-button type="primary" plain size="small" @click="openPreview"
                ...
                >
                  <a-button size="small" danger block
                ...
                >
                  <a-button class="_fd-m-extend" plain size="small">
                    <i class="fc-icon icon-more"></i>
                  </a-button>
                  <template #overlay>
                    <a-menu>
              ...
              <template v-if="getConfig('showInputData', true)">
                ...
                <div class="_fd-input-btn">
                  <a-switch
                    v-model:checked="inputForm.state"
                    @change="
                      (checked) => {
                        $emit('update:model-value', openInputData(checked));
                      }
                    "
                  >
          ...
          <a-layout-content class="_fc-m-con">
            ...
            <div class="_fc-m-input-handle" v-if="inputForm.state">
              <a-button plain @click="inputClear()">{{
                t("props.clear")
              }}</a-button>
              <a-button plain @click="inputReset()">{{
                t("props.reset")
              }}</a-button>
              <a-button type="primary" plain @click="inputSave()">{{
                t("props.save")
              }}</a-button>
            </div>
          </a-layout-content>
            ...
            >
              ...
              >
                <div style="grid-area: base;">
                  <a-divider v-if="baseForm.isShow">{{
                    t("designer.rule")
                  }}</a-divider>
                  <DragForm
                ...
                <div style="grid-area: props;">
                  <a-divider v-if="propsForm.isShow"
                    >{{ t("designer.props") }}
                    <PropsInput
                  ...
                  ></DragForm>
                  <a-divider v-if="customForm.isShow && customForm.propsShow">
                    {{ t("designer.props") }}
                  </a-divider>
                  <DragForm
                ...
                <div v-if="activeRule" style="grid-area: validate;">
                  <a-divider v-if="validateForm.isShow"
                    >{{ t("designer.validate") }}
                  </a-divider>
                  <DragForm
...
export default defineComponent({
  ...
  setup(props) {
    ...
    watch(
      ...
      (n) => {
        ...
        if (rule) {
          ...
          data.propsForm.rule = data.cacheProps[
            rule._fc_id
    ...
    const methods = {
      ...
      getRule() {
        // console.log(data.dragForm.rule[0].children);
      ...
      handleChange(key, field, value, _, fapi) {
        if (
          ...
          methods.unWatchActiveRule();
          const org = field;
          console.log(key, field, value, _, fapi);
          if (field.indexOf("__") !== 0) {
            /**
             * 特殊处理 antd 日期 placeholder
             */
            if (field === "startPlaceholder" || field === "endPlaceholder") {
              data.activeRule.props.placeholder = data.activeRule.props
                .placeholder
                ? data.activeRule.props.placeholder
                : new Array(2);
              if (field === "startPlaceholder")
                data.activeRule.props.placeholder[0] = value;
              if (field === "endPlaceholder")
                data.activeRule.props.placeholder[1] = value;
